...
$ding = mysqli_query($conn, "SELECT * FROM finishedorders WHERE orderid =".$orderid);
$result = $ding->fetch_assoc();
mysqli_query($conn, "INSERT INTO orderstable 
...
mysqli_query($conn, "DELETE FROM finishedorders WHERE orderid =".$orderid);
